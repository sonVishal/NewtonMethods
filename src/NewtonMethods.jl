...
export OPT_RTOL, OPT_QSUCC, OPT_MODE, OPT_JACGEN, OPT_JACFCN, OPT_MSTOR, OPT_ML,
        ...
        OPT_FCSTART, OPT_FCMIN, STATS_NITER, STATS_NCORR, STATS_NFCN, STATS_NFCNJ,
        STATS_NJAC, STATS_NREJR1, STATS_XSCAL, STATS_RTOL, STATS_XITER,
        STATS_NATLEVEL, STATS_SIMLEVEL, STATS_STDLEVEL, STATS_PRECISION,
        STATS_DAMPINGFC, STATS_NEW, STATS_ICONV, STATS_CONV, STATS_SUMX, STATS_DLEVF
